			...
			return this.each(
				function()
				{
					...
					if (!alreadyExists && s.createButton) {
						// create it!
						controller.button = $('<a  class="dp-choose-date" title="' + $.dpText.TEXT_CHOOSE_DATE + '">' + $.dpText.TEXT_CHOOSE_DATE + '</a>')
								.bind(
									'click',
									function()
									{
...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										$('<a class="dp-nav-prev-year"  title="' + $.dpText.TEXT_PREV_YEAR + '">&lt;&lt;</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-prev-month"  title="' + $.dpText.TEXT_PREV_MONTH + '">&lt;</a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										$('<a class="dp-nav-next-year"  title="' + $.dpText.TEXT_NEXT_YEAR + '">&gt;&gt;</a>')
											.bind(
												'click',
												function()
												{
										...
										$('<a class="dp-nav-next-month"  title="' + $.dpText.TEXT_NEXT_MONTH + '">&gt;</a>')
											.bind(
												'click',
												function()
												{
				...
				if (this.displayClose) {
					$pop.append(
						$('<a  id="dp-close">' + $.dpText.TEXT_CLOSE + '</a>')
							.bind(
								'click',
								function()
								{
